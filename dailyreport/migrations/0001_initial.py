    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='items', to='dailyreport.driverdailyreportsegment', verbose_name='所属车辆分段')),
            ],
        ),
        migrations.CreateModel(
